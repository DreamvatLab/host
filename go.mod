module github.com/DreamvatLab/host

go 1.26.1

replace github.com/DreamvatLab/go => ../go

replace github.com/DreamvatLab/oauth2go => ../oauth2go

require (
	github.com/DreamvatLab/go v1.0.22
	github.com/DreamvatLab/logs v1.0.7
	github.com/DreamvatLab/oauth2go v1.0.12
